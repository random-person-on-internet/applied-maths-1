...
int main()
{
    ...
    printf("Enter number of row you want to add (source row) : ");
    scanf("%d", &source_row);

    printf("Enter number of row you want to make changes in (target row) : ");
    scanf("%d", &target_row);

    printf("Enter number you want to multiply to source row before addition : ");
    scanf("%d", &multiplier);

    // Loop for addition, logic works almost same way as row exchange
